...
export type EditableTask = Pick<Task, "title" | "description" | "labels" | "priority"> & Partial<Pick<Task, "taskid">> & Partial<Pick<Task, "due_date">>;
...
export default function TodoEditor({ task, onSave }: TodoEditorProps) {
        ...
        <div className="flex-1 relative shrink-0 w-[26rem] h-full bg-white shadow-md rounded-lg p-4 overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
                ...
                <h2 className="grow text-2xl font-bold">
                    {!task.taskid ? "[新規作成]" : "[編集中]"} {editedTask.title}
                </h2>
            </div>
            <div className="mb-4">
